	...
	<div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
		<form class="bg-white">
			...
			<div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
				...
				<input class="pl-2 outline-none border-none" type="text" placeholder="Username" />
			</div>
			...
			<!-- Register Button -->
            <a href="/admin/pages/contact" class="block w-full bg-indigo-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2 text-center">Login</a>

            <a href="/admin/pages/register">
                <span class="text-sm ml-2 hover:text-blue-500 cursor-pointer">Create an Account</span>
            </a>
		</form>
	</div>

	<!-- Gradient Background Section (Now on the right) -->
