...
<div class="h-screen md:flex">
	<div class="relative overflow-hidden md:flex w-1/2 bg-gradient-to-tr from-blue-800 to-purple-700 i justify-around items-center hidden">
		<div>
			<h1 class="text-3xl text-white font-bold">Register</h1>
		</div>
	...
	<div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
		<form class="bg-white">
			...
			<!-- Confirm Password -->
			<div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-12">
				<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
					<path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd" />
				</svg>
				<input class="pl-2 outline-none border-none" type="password" name="confirm_password" id="confirm_password" placeholder="Confirm Password" />
			</div>

			<!-- Register Button -->
			<a href="/admin/pages/login" class="block w-full bg-indigo-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2 text-center">
				Register
			</a>
            <a href="/admin/pages/login">
                <span class="text-sm ml-2 hover:text-blue-500 cursor-pointer">Already Have an Account ? Login here</span>
            </a>
		</form>
	</div>
</div>
